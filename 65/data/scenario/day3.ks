...
[cm  ]
[tb_eval  exp="f.day=3"  name="day"  cmd="="  op="t"  val="3"  val_2="undefined"  ]
[tb_start_tyrano_code]
[fuki_chara name="others" fix_width="" max_width=500]
[_tb_end_tyrano_code]

[tb_start_tyrano_code]
[fuki_chara name="65" fix_width="" max_width=400 sippo="none"]
[_tb_end_tyrano_code]
...
[bg  time="0"  method="crossfade"  storage="00背景_暗闇_0-sharedassets0.assets-75.png"  ]
[tb_ptext_show  x="245"  y="430"  size="55"  color="0xffffff"  time="2000"  text="３日目"  anim="false"  face="mplus-1c-heavy-sharedassets0assets-63"  edge="undefined"  shadow="undefined"  ]
...
そうだね      [p]
今日が最終日だ。[p]
いまのところ記憶が戻る気配はないが、[r]本当にうまくいくのだろうか。[p]
ともかく、彼女の記憶を[r]刺激してみるしかない。[p]
今日はどうする？[p]
[_tb_end_text]
